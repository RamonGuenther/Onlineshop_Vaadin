...
public class TestDataInit {
    ...
    private void initTestData(){
        ...
        ProductImage imageSmartphone1_1 = new ProductImage("01_s21ultra.jpeg", ImageType.JPEG, smartphone1);
        ...
        ProductImage imageSmartphone1_2 = new ProductImage("02_s21ultra.jpeg", ImageType.JPEG, smartphone1);
        ...
        ProductImage imageSmartphone2_1 = new ProductImage("03_iphone13promax.png", ImageType.JPEG, smartphone2);
        ...
        ProductImage imageSmartphone2_2 = new ProductImage("04_iphone13promax.png", ImageType.JPEG, smartphone2);
        ...
        ProductImage imagePlaystation_1 = new ProductImage("05_playstation5.jpeg", ImageType.JPEG, playstation);
        ...
        ProductImage imagePlaystation_2 = new ProductImage("06_playstation5.jpeg", ImageType.JPEG, playstation);
        ...
        ProductImage imageGame1 = new ProductImage("07_residentevil.jpeg", ImageType.JPEG, game1);
        ...
        ProductImage imageGame2 = new ProductImage("08_crusaderkings.jpeg", ImageType.JPEG, game2);
        ...
        ProductImage imageGame3 = new ProductImage("09_pokemon.jpeg", ImageType.JPEG, game3);
        ...
        ProductImage imagePc1_1 = new ProductImage("10_asuszenbook.jpeg", ImageType.JPEG, pc1);
        imagePc1_1.setData("10_asuszenbook.jpeg");
        imageService.saveImage(imagePc1_1);
        pc1.addImage(imagePc1_1);
        ProductImage imagePc1_2 = new ProductImage("11_asuszenbook.jpeg", ImageType.JPEG, pc1);
        imagePc1_2.setData("11_asuszenbook.jpeg");
        imageService.saveImage(imagePc1_2);
        pc1.addImage(imagePc1_2);
        ProductImage imagePc1_3 = new ProductImage("12_asuszenbook.jpeg", ImageType.JPEG, pc1);
        imagePc1_3.setData("12_asuszenbook.jpeg");
        imageService.saveImage(imagePc1_3);
        pc1.addImage(imagePc1_3);
        ProductImage imagePc1_4 = new ProductImage("13_asuszenbook.jpeg", ImageType.JPEG, pc1);
        ...
        ProductImage imagePc2_1 = new ProductImage("14_surface8.jpeg", ImageType.JPEG, pc2);
        imagePc2_1.setData("14_surface8.jpeg");
        imageService.saveImage(imagePc2_1);
        pc2.addImage(imagePc2_1);
        ProductImage imagePc2_2 = new ProductImage("15_surface8.jpeg", ImageType.JPEG, pc2);
        imagePc2_2.setData("15_surface8.jpeg");
        imageService.saveImage(imagePc2_2);
        pc2.addImage(imagePc2_2);
        ProductImage imagePc2_3 = new ProductImage("16_surface8.jpeg", ImageType.JPEG, pc2);
        imagePc2_3.setData("16_surface8.jpeg");
        imageService.saveImage(imagePc2_3);
        pc2.addImage(imagePc2_3);
        ProductImage imagePc2_4 = new ProductImage("17_surface8.jpeg", ImageType.JPEG, pc2);
        ...
        ProductImage imagePc3_1 = new ProductImage("18_chromebook.jpeg", ImageType.JPEG, pc3);
        imagePc3_1.setData("18_chromebook.jpeg");
        imageService.saveImage(imagePc3_1);
        pc3.addImage(imagePc3_1);
        ProductImage imagePc3_2 = new ProductImage("19_chromebook.jpeg", ImageType.JPEG, pc3);
        imagePc3_2.setData("19_chromebook.jpeg");
        imageService.saveImage(imagePc3_2);
        pc3.addImage(imagePc3_2);
        ProductImage imagePc3_3 = new ProductImage("20_chromebook.jpeg", ImageType.JPEG, pc3);
